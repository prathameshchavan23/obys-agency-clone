...
function loadingAnimation() {
  ...
  tl.from("#line1-part1", {
    ...
    onStart: function () {
      ...
      var grow = 0;
      //to update values at loader we used setInterval function(it is like a loop which acts after certain interval of time), where we basically give loop for 100 times and printed it's values direcly using var on screen with innerHtml or textcontent
